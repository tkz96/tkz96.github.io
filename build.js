...
<body>
  ...
  <header class="site-header">
    <div class="header-container">
      ...
      <div class="header-controls">
        ...
        <button type="button" class="theme-toggle-btn" id="theme-toggle" aria-label="Switch to dark theme" onclick="toggleTheme()">
          <span class="theme-toggle-icon" id="theme-toggle-icon" aria-hidden="true">
            <svg class="theme-icon-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>
          </span>
  ...
  <script>
    ...
    function updateThemeIcon() {
      ...
      const moonSvg = '<svg class="theme-icon-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>';
      ...
      if (button) {
        ...
        if (labelSpan) {
          labelSpan.textContent = isDark ? 'Light theme' : 'Dark theme';
        }
      }
    }
